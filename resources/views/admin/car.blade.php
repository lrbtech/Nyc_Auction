            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Modal List</h5>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input value="{{$id}}" type="hidden" name="brand_id">
                    <div class="form-group row">
                      <label class="col-md-3 label-control" for="projectinput1">Car Name</label>
                      <div class="col-md-9">
                        <input type="text" id="name" class="form-control" placeholder="Car Name" name="name">
                      </div>
                    </div>
                    <!-- <div class="form-group row">
                      <label class="col-md-3 label-control" for="projectinput1">Choose Imge</label>
                      <div class="col-md-9">
...
function Edit(id){
  $.ajax({
    url : '/admin/edit-car/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      $('#modal-title').text('Update Modal');
