            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Vehicle List</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="/dashboard"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Vehicle Type
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9">
              <input type="text" id="name" class="form-control" placeholder="Vehicle Type" name="name">
            </div>
          </div>
...
function Delete(id){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/vehicle-type-delete/'+id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
