...
@else--}}
    <div class="col-xl-4 col-md-6 col-12 dashboard-greetings">
      <div class="card">
        <div class="card-header">
          <h3 class="greeting-text">Congratulations Prasanth!</h3>
          <p class="mb-0">Today Auction Winner</p>
        </div>
        <div class="card-content">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-end">
              <div class="dashboard-content-left">
              <!-- class ="font-large-2" -->
                <h1 class="text-primary text-bold-500">AED 0</h1>
                <p>You won XUV 5OO.</p>
                <a href="/admin/auction-winners"><button type="button" class="btn btn-primary glow">View Auction</button></a>
              </div>
              <div class="dashboard-content-right">
    ...
    <div class="col-xl-4 col-md-6 col-12 dashboard-latest-update">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center pb-50">
          <h4 class="card-title">Today Auction List</h4>
          <!-- <div class="dropdown">
            ...
            <ul class="list-group list-group-flush">
              <li
                ...
                <div class="list-left d-flex">
                  ...
                  <div class="list-content">
                    <span class="list-title">Salvage Cars</span>
              ...
              <li
                ...
                <div class="list-left d-flex">
                  ...
                  <div class="list-content">
                    <span class="list-title">New Cars</span>
                    <small class="text-muted d-block">02:00 PM</small>
                  </div>
                </div>
                <span>5</span>
              </li>
              <li
                ...
                <div class="list-left d-flex">
                  ...
                  <div class="list-content">
                    <span class="list-title">Old Cars</span>
                    <small class="text-muted d-block">06:00 PM</small>
                  </div>
                </div>
                <span>4</span>
              </li>
                ...
                <div class="card-body d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    <div class="avatar bg-rgba-warning m-0 p-25 mr-75 mr-xl-2">
                      <div class="avatar-content">
                        <i class="menu-livicon text-warning font-medium-2" data-icon="car"></i>
                      </div>
                    </div>
                    <div class="total-amount">
                      <h5 class="mb-0">0</h5>
              ...
              <div class="card">
                <div class="card-body d-flex align-items-center justify-content-between">
                  <div class="d-flex align-items-center">
                    ...
                    <div class="total-amount">
                      <h5 class="mb-0">0</h5>
                      <small class="text-muted">Todal Auction</small>
                    </div>
                  </div>
                </div>
              </div>
