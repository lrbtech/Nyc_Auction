            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                    <div class="row">
        				...
        				<form id="form" action="/admin/services" method="POST" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                    	<input value="{{ $data['id'] }}" type="hidden" name="id" id="id">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label>Services</label>
                                <textarea id="services" rows="2" class="form-control tinymce" name="services"><?php echo $data['services']?> </textarea>
                            </div>
                        </div>
