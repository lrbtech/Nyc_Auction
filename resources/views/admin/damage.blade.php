            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Damage List</h5>
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    <li class="breadcrumb-item"><a href="/dashboard"><i class="bx bx-home-alt"></i></a>
                                    </li>
                                    <li class="breadcrumb-item active">Damage
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="id" id="id">
                    ...
                    <div class="form-group">
                        <label>Damage</label>
                        <input autocomplete="off" type="text" id="damage" name="damage" class="form-control">
                    </div>
...
function Edit(id){
  $.ajax({
    ...
    success: function(data)
    {
      $('#modal-title').text('Update Damage');
