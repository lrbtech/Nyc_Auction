            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                    <div class="row">
        				...
        				<form id="form" action="/admin/terms-and-conditions" method="POST" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                    	<input value="{{ $data['id'] }}" type="hidden" name="id" id="id">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label>Terms and Condition</label>
                                <textarea id="terms_and_conditions" rows="2" class="form-control tinymce" name="terms_and_conditions"><?php echo $data['terms_and_conditions']?> </textarea>
                            </div>
                        </div>
