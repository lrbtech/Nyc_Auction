            ...
            <div class="content-header row">
                <div class="content-header-left col-12 mb-2 mt-1">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h5 class="content-header-title float-left pr-1 mb-0">Brand List</h5>
        ...
        <div class="card-content">
            ...
            <div class="table-responsive">
                ...
                <tbody>
                   ...
                   <tr>
                    <td>{{$x}}</td>
                    <td><a href="/admin/car/{{$row->id}}">{{$row->name}}</a></td>
    ...
    <div class="modal-dialog " role="document">
        <div class="modal-content">
          ...
          <div class="form-group row">
            <label class="col-md-3 label-control">Brand Name</label>
            <div class="col-md-9">
              <input type="text" id="name" class="form-control" placeholder="brand Name" name="name">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-md-3 label-control">Choose Imge</label>
            <div class="col-md-9">
