                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb p-0 mb-0">
                                    ...
                                    <li class="breadcrumb-item active">How it Works
                                    </li>
                                </ol>
                            </div>
                        </div>
            ...
            <div class="content-body">
                ...
                <section id="basic-datatable">
                    <div class="row">
        				...
        				<form id="form" action="/admin/how-it-works" method="POST" enctype="multipart/form-data">
                    	{{ csrf_field() }}
                    	<input value="{{ $data['id'] }}" type="hidden" name="id" id="id">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <label>How it Works</label>
                                <textarea id="how_it_works" rows="2" class="form-control tinymce" name="how_it_works"><?php echo $data['how_it_works']?> </textarea>
                            </div>
                        </div>
